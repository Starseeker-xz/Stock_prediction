...
class ModelConfig:
    ...
    # 是否归一化
    # 时间特征默认不归一化（已在 [-1, 1]）
    FEATURE_NORMALIZE_MASK_SHORT_MEDIUM = [True, True, True, True, True, False, True] + [False] * len(TIME_FEATURES_SHORT_MEDIUM)
    ...
    TCN_CHANNELS = [32, 64, 64] # TCN layers
